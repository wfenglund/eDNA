...
arterna stod för över `r commonPercent`% av sekvenserna från `r targetGroup` (se figur 1). Övriga sekvenser var
av låg kvalitet eller var spår av andra organismer.

```{r tab2, echo=FALSE}
fixedCaption <- paste("Tabell över latinska och svenska namn på de arter av", targetGroup, "som identifierats i proverna. Om sekvenser ej kunde bestämmas till exakt art anges i dessa fall ", "sp.", " eller vilka två arter det kan handla om.", sep = "'")
...
från `r speciesNo` olika arter av `r targetGroup`. Vår bedömning är att
