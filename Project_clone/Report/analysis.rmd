...

{
  ...
  ### Curate:
  # groupNotes <- RenameSpecies("hit reference", "new latin name", groupNotes)
  # groupNotes <- CombineSpecies("hit to be kept", "hit to be absorbed", groupNotes)
  groupNotes$Swedish[groupNotes$Reference %in% c("hitX")] <- "new common name"
