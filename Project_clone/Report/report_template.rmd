...
totalSeqs <- "NUMBER" # Total number of raw sequences
minSeqs <- "NUMBER" # Number of sequences in the sample with fewest sequences
maxSeqs <- "NUMBER" # Number of sequences in the sample with most sequences
primerPercent <- "NUMBER" # Percentage of sequences that contained primers
groupPercent <- "NUMBER" # Percentage of sequences belonging to target group
...
enskilda prov hade mellan `r minSeqs` och `r maxSeqs` sekvenser. Omkring `r primerPercent`% av sekvenserna
...
nödvändigtvis garanterar att dessa arter är frånvarande.
