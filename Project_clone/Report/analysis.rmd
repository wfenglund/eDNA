...
# Collect sample paths and names. Add one per primer.
...
blastResYkarp <- BlastParse(yAll2, "y_387karp.out")
saveRDS(blastResYkarp, file = "blastResYkarp.rds")
```

### Create Summaryfiles from the BLAST-results:
```{r}
allResultskarp <- SumRes(blastRes = blastResYkarp, counts = yAll2$counts, taxGroup = "Fish") # Summarize a list of result objects
```
